  ...
  data() {
    return {
      ...
      rules: {
        ...
        locationID: [
          { required: true, message: "Please select input Locaton " }
        ]
      }
    };
  },
